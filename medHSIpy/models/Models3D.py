...
class my_3DCNN(nn.Module):
    def __init__(self, num_of_class):
        ...
        self.conv1D_layers = nn.Sequential(
            nn.Conv3d(1, 2, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(2),
            nn.MaxPool3d((2,1,1)),
            nn.ReLU(),
            nn.Conv3d(2, 4, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(4),
            nn.MaxPool3d((2,1,1)),
            nn.ReLU(),
            ...
            nn.MaxPool3d((2,1,1)),
            nn.ReLU(),
            nn.Conv3d(8, 16, kernel_size=(3,1,1), padding=(1,0,0)),
            nn.BatchNorm3d(16),
            nn.MaxPool3d((2,1,1)),
            nn.ReLU(),
        ...
        self.fc1 = nn.Linear(128*3*16*16, num_of_class)
...
class new_my_3DCNN(nn.Module):
    def __init__(self, num_of_class):
        super(new_my_3DCNN, self).__init__()
